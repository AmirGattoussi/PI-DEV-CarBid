        ...
        if (radio_btn_live.isSelected()) {
            try {
                ...
                if ((txt_live_bid.getText().isEmpty()) && (!(txt_max_bid.getText().isEmpty()))
                    ...
                    // refreshScene(event);
                    refreshTextFields();
                    System.out.println("succeeeeeees");
                }
...
//
// Instant instant =
// deadline.toLocalDate().atStartOfDay().toInstant(ZoneOffset.UTC);;
// ZoneId zone = ZoneId.systemDefault();
// LocalDate deadli = instant.atZone(zone).toLocalDate();
// Timeline timeline = new Timeline(new
// KeyFrame(javafx.util.Duration.seconds(1), event -> {
// if (deadline != null) {
// Instant now = Instant.now();
// LocalDateTime localDateTime =
// instant.atZone(ZoneId.systemDefault()).toLocalDateTime();
// Instant deadlineInstant =
// deadli.atStartOfDay(ZoneId.systemDefault()).toInstant();
// Duration duration = java.time.Duration.between(now, deadlineInstant);
// if (duration.isNegative()) {
// txt_time.setText("Deadline has passed");
// } else {
...
// long minutes = duration.toMinutes() % 60;
// long seconds = duration.getSeconds() % 60;
// String remainingTime = String.format("%02d:%02d:%02d", hours, minutes,
// seconds);
// txt_time.setText(remainingTime);
// }
// }
...
// //bid.setLiveBidAmount(Float.parseFloat(txt_live_bid.getText()));
//
// if ((txt_live_bid.getText().isEmpty()) &&
// (!(txt_max_bid.getText().isEmpty())) || (txt_live_bid.getText().isEmpty()) ||
// (txt_live_bid.getText().isEmpty()) && (txt_max_bid.getText().isEmpty())) {
//
// Alert alert = new Alert(AlertType.WARNING);
...
// alert.setContentText("Please enter only a live bid amount");
// alert.showAndWait();
// } else if (!(txt_live_bid.getText().matches("[0-9]*")) &&
// (!(txt_live_bid.getText().isEmpty()))) {
//
// Alert alert = new Alert(AlertType.WARNING);
// alert.setTitle("Invalid Input");
...
// alert.showAndWait();
//
// } else if (Float.parseFloat(txt_live_bid.getText()) <=
// Float.parseFloat(txt_highest_bid.getText())) {
//
// Alert alert = new Alert(AlertType.WARNING);
// alert.setTitle("Invalid Input");
// alert.setHeaderText(null);
// alert.setContentText("Please enter a live bid amount bigger than the current
// bid");
// alert.showAndWait();
//
// } else {
...
//
// if ((txt_live_bid.getText().isEmpty()) &&
// (!(txt_max_bid.getText().isEmpty())) || (txt_max_bid.getText().isEmpty()) &&
// (!(txt_live_bid.getText().isEmpty()))) {
// Alert alert = new Alert(AlertType.WARNING);
// alert.setTitle("Invalid Input");
// alert.setHeaderText(null);
// alert.setContentText("Please enter both a live bid amount and a max bid
// amout");
// alert.showAndWait();
// }
// } catch (NumberFormatException ex) {
...
// }
//
// if (!(txt_max_bid.getText().matches("[0-9]*")) &&
// (!(txt_max_bid.getText().isEmpty()))) {
//
// Alert alert = new Alert(AlertType.WARNING);
// alert.setTitle("Invalid Input");
// alert.setHeaderText(null);
...
/// *
// @FXML
// void Live(ActionEvent event) throws SQLException, IOException {
// BidDaoImplementation bid_dao = new BidDaoImplementation();
// float count = 1;
// while (count < 500) {
// try {
// bid_dao.addLiveBid(new Bid(2, 2,
// Float.parseFloat(txt_live_bid.getText())+count*500));
// Thread.sleep(1500);
// } catch (InterruptedException ex) {
// System.out.println("Controller.BidController.Live()");
// }
// count++;
// refreshTextFields();
// }
